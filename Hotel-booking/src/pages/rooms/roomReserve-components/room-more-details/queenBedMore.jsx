...
function QueenBedMore({ isMoreDetails, setIsMoreDetails }) {
  if (isMoreDetails) {
                ...
                <ul>
                  {secondListQueen.map((item) => (
                    <li key={item.name}>
                      ...
                      />
                      <p>
                        {item.name} {item.name.includes("23") && <sup>2</sup>}
                      </p>
                    </li>
                  ))}
                </ul>
